    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Monitor the health and activity of the EPay platform
        </p>
      </div>
                ...
                {recentPayments.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${statusColors[p.status]}`}
                      >
                        {p.status}
                      </span>
                    </td>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-2xl p-5">
          ...
          <div className="space-y-3">
            {pendingActions.map((action, i) => (
              <div
                key={i}
                className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-white/5"
              >
                <div
