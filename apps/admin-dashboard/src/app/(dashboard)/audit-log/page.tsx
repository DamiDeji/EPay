...
const auditLogs = [
  ...
  { id: 'log_002', action: 'payment.refunded', resource: 'Payment', resourceId: 'pay_k1l2', userId: 'admin_001', userName: 'Admin User', details: 'Processed manual refund for payment pay_k1l2', changes: { status: 'completed → refunded', amount: '100 TON' }, ip: '192.168.1.100', timestamp: '2026-08-05T13:45:00Z' },
