...
// `fill` drives the slice colour (Recharts reads it from the datum — see
// `Pie.js` "sectorColor") and `color` drives the legend swatch below. This
// replaces a `<Cell>` child per datum, which Recharts 3.10 deprecated and will
// remove in 4.0.
const PIE_DATA = [
  { name: 'XLM', value: 65, color: '#0098EA', fill: '#0098EA' },
  { name: 'USDT', value: 20, color: '#10B981', fill: '#10B981' },
  { name: 'USDC', value: 10, color: '#1E3A8A', fill: '#1E3A8A' },
  { name: 'Other', value: 5, color: '#94a3b8', fill: '#94a3b8' },
];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">
          Deep insights into your payment activity and revenue trends.
        </p>
      </div>
