...
const SETTLEMENTS = [
  { id: 'set_a1B2c', amount: '890.25 TON', fee: '4.45 TON', net: '885.80 TON', status: 'COMPLETED', payments: 45, period: 'Jul 28 - Aug 4', txHash: '0xSET...001', date: '2026-08-04' },
  { id: 'set_d3E4f', amount: '720.50 TON', fee: '3.60 TON', net: '716.90 TON', status: 'COMPLETED', payments: 38, period: 'Jul 21 - Jul 28', txHash: '0xSET...002', date: '2026-07-28' },
  { id: 'set_g5H6i', amount: '945.80 TON', fee: '4.73 TON', net: '941.07 TON', status: 'COMPLETED', payments: 52, period: 'Jul 14 - Jul 21', txHash: '0xSET...003', date: '2026-07-21' },
  { id: 'set_j7K8l', amount: '320.00 TON', fee: '1.60 TON', net: '318.40 TON', status: 'PROCESSING', payments: 18, period: 'Aug 4 - Aug 11', txHash: null, date: '2026-08-05' },
  { id: 'set_m9N0p', amount: '145.25 TON', fee: '0.73 TON', net: '144.52 TON', status: 'FAILED', payments: 8, period: 'Aug 4 - Aug 11', txHash: null, date: '2026-08-05' },
];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Pending Balance', value: '320.00 TON', sub: 'Next settlement: Aug 11' },
          { label: 'Total Settled', value: '2,556.55 TON', sub: 'Lifetime settlements' },
          { label: 'Total Fees', value: '12.78 TON', sub: '0.5% effective rate' },
        ].map((s) => (
                  ...
                  return (
                    <tr key={s.id} className="border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="py-4 px-4 text-right">
                        {s.txHash ? <a href={`https://tonscan.org/tx/${s.txHash}`} target="_blank" className="text-[#0098EA] hover:underline text-xs flex items-center gap-1 justify-end"><ExternalLink className="w-3 h-3" />View</a> : <span className="text-xs text-slate-400">-</span>}
                      </td>
                    </tr>
                  );
                })}
