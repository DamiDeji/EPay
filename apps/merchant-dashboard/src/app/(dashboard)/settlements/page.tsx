      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Periodic settlement of accumulated payments to your wallet.
          </p>
        </div>
                  ...
                  return (
                    ...
                    >
                      <td className="py-4 px-4">
                        <span className="font-mono text-xs text-[#0098EA]">{s.id}</span>
                      </td>
                      ...
                      <td className="py-4 px-4 text-right">
                        {s.txHash ? (
                          <a
                            href={`https://stellar.expert/explorer/public/tx/${s.txHash}`}
                            target="_blank"
                            className="text-[#0098EA] hover:underline text-xs flex items-center gap-1 justify-end"
                          >
