    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Search by ID or payer address..."
            value={search}
            onChange={(e) => {
                  ...
                  return (
                    ...
                    >
                      <td className="py-4 px-4">
                        <span className="font-mono text-xs font-medium text-[#0098EA]">{p.id}</span>
                      </td>
                      <td className="py-4 px-4">
                      ...
                      <td className="py-4 px-4 text-right">
                        {p.txHash ? (
                          <a
                            ...
                            className="inline-flex items-center gap-1 text-[#0098EA] hover:underline text-xs"
                          >
