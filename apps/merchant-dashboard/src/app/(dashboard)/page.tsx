...
import { DollarSign, CreditCard, TrendingUp, Users, Clock, ArrowUpRight } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">
          Welcome back,{' '}
          <span className="font-medium text-slate-900 dark:text-white">Acme Store</span> —
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              {[
                ...
                <div key={item.label} className="flex items-center gap-2">
                  ...
                  <div className="text-xs font-semibold ml-auto text-slate-900 dark:text-white">
                    {item.value}
                  </div>
                </div>
              ))}
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <a
            ...
            className="text-sm text-[#0098EA] hover:underline flex items-center gap-1"
          >
                ...
                {RECENT.map((p) => (
                  ...
                  >
                    <td className="py-3 px-2">
                      <span className="font-mono text-xs text-[#0098EA]">{p.id}</span>
                    </td>
                    ...
                    <td className="py-3 px-2">
                      <Badge variant={statusColors[p.status]} className="text-xs">
                        {p.status}
                      </Badge>
                    </td>
