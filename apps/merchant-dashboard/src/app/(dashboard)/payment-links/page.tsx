...
const LINKS = [
  {
    id: 'link_a1B2c',
    code: 'pay-demo-store',
    url: 'https://epay.dev/pay/pay-demo-store',
    amount: '50 XLM',
    currency: 'XLM',
    description: 'Demo Store Payment',
    maxPayments: null,
    current: 15,
    status: 'ACTIVE',
  ...
  },
  {
    id: 'link_d3E4f',
    code: 'summer-sale',
    url: 'https://epay.dev/pay/summer-sale',
    amount: '25 XLM',
    currency: 'XLM',
  ...
  },
  {
    id: 'link_g5H6i',
    code: 'consulting',
    url: 'https://epay.dev/pay/consulting',
    amount: '200 XLM',
    currency: 'XLM',
  ...
  },
  {
    id: 'link_j7K8l',
    code: 'old-campaign',
    url: 'https://epay.dev/pay/old-campaign',
    amount: '10 XLM',
    currency: 'XLM',
          ...
          <Card key={link.id} className="hover:shadow-md transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <Badge variant={link.status === 'ACTIVE' ? 'success' : 'slate'}>
                  {link.status}
                </Badge>
              ...
              <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-3 flex items-center justify-between mb-3">
                <code className="text-xs font-mono text-slate-600 dark:text-slate-300 truncate max-w-[240px]">
                  {link.url}
                </code>
