...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      {/* The page's content is wrapped in a `main` landmark: without one, screen
          readers and axe cannot skip the navigation, and every section is
          reported as content outside any landmark. */}
      <main>
        {/* Hero Section */}
              ...
              <div className="relative">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Link href="/register">
                    <Button
                      size="xl"
                      className="bg-white text-[#1E3A8A] hover:bg-white/90 shadow-lg"
                    >
